...
var file_lbbft_proto_rawDesc = []byte{
	...
	0x74, 0x32, 0xec, 0x01, 0x0a, 0x05, 0x4c, 0x42, 0x42, 0x46, 0x54, 0x12, 0x37, 0x0a, 0x08, 0x4f,
	...
	0x6f, 0x65, 0x2d, 0x7a, 0x78, 0x68, 0x2f, 0x6c, 0x62, 0x62, 0x66, 0x74, 0x2f, 0x69, 0x6e, 0x74,
...
var file_lbbft_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
var file_lbbft_proto_depIdxs = []int32{
	...
	0,  // 8: proto.LBBFT.Ordering:input_type -> proto.OrderingArgs
	2,  // 9: proto.LBBFT.PrePrepare:input_type -> proto.PrePrepareArgs
	4,  // 10: proto.LBBFT.Prepare:input_type -> proto.PrepareArgs
	6,  // 11: proto.LBBFT.Commit:input_type -> proto.CommitArgs
	1,  // 12: proto.LBBFT.Ordering:output_type -> proto.OrderingReply
	3,  // 13: proto.LBBFT.PrePrepare:output_type -> proto.PrePrepareReply
	5,  // 14: proto.LBBFT.Prepare:output_type -> proto.PrepareReply
	10, // 15: proto.LBBFT.Commit:output_type -> google.protobuf.Empty
